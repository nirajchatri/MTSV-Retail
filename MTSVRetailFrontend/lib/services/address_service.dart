...
class AddressService {
  static const String baseUrl = 'https://api.mtsvretail.com';
  ...
  Future<List<Address>> getAddresses() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('https://api.mtsvretail.com/api/address/list'),
        headers: {
  ...
  Future<Map<String, dynamic>> addAddress({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://api.mtsvretail.com/api/address/add'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
  ...
  Future<Map<String, dynamic>> editAddress({
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse('https://api.mtsvretail.com/api/address/edit/$addressId'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
  ...
  Future<Address?> getDefaultAddress() async {
    ...
    final response = await http.get(
      Uri.parse('https://api.mtsvretail.com/api/address/default'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
      },
