# Postman Setup Guide for MTSV Retail Admin APIs

This guide will help you set up and use the Postman collection for testing all admin APIs.

## 📁 **Files Provided**

- `MTSV Retail_Admin_APIs.postman_collection.json` - Complete Postman collection with all 13 admin APIs
...
3. Drag and drop `MTSV Retail_Admin_APIs.postman_collection.json` file
4. Click **Import**

### Step 2: Set Environment Variables

1. Click on **Environments** in the sidebar
2. Create a new environment called "MTSV Retail Admin"
...
- In the top-right corner of Postman, select "MTSV Retail Admin" environment
...
1. **Check Environment**: Ensure "MTSV Retail Admin" environment is selected
